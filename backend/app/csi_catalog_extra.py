...
EXTRA_SECTIONS: tuple[tuple[str, str], ...] = (
    ...
    ("105113", "Metal Lockers (standard, heavy-duty, and welded steel)"),
    ("105126", "Plastic Lockers"),
    ("105129", "Phenolic Lockers (solid phenolic, moisture-resistant)"),
    ("105133", "Wood and Laminate Lockers (club and athletic lockers)"),
    ("105143", "Wire Mesh Storage Lockers (security cages and gear storage)"),
