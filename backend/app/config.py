...
class Config:
    ...
    # Bid Board opportunities: APS filter[updatedAt] range. Empty = last 14 days on the
    # website sync. Historical backfill is ``scripts/sync_buildingconnected_opportunities.py --full``.
