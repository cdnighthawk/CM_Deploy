...
(function (global) {
	...
	var ES = {
		...
		Upload: "Cargar",
		Export: "Exportar",
		"Current Drawings": "Planos actuales",
		"Drawing Sets": "Juegos de planos",
		"All Filters": "Todos los filtros",
		"Drawing Title": "Título del plano",
		Revision: "Revisión",
		Revisions: "Revisiones",
		"Drawing Date": "Fecha del plano",
		"Received Date": "Fecha de recepción",
		Published: "Publicado",
		Draft: "Borrador",
		"See All": "Ver todos",
		...
		"Open drawing": "Abrir plano",
		Info: "Info",
		File: "Archivo",
		Rev: "Rev",
		Current: "Actuales",
		"All disciplines": "Todas las disciplinas",
		"Change drawing #": "Cambiar # de plano",
		"Change drawing name": "Cambiar nombre del plano",
		"No drawing sets yet.": "Aún no hay juegos de planos.",
		"No drawings for this project yet.": "Aún no hay planos en este proyecto.",
		"View, manage, and upload all of your drawings from the Drawings log.":
			"Consulte, administre y cargue todos los planos desde el registro de planos.",
